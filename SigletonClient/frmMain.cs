...
namespace SigletonPattern.SigletonClient
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.rtb_Result.Size = new System.Drawing.Size(416, 200);
			this.rtb_Result.TabIndex = 2;
			this.rtb_Result.Text = "";
			// 
			// btn_Exit
			// 
			this.btn_Exit.Location = new System.Drawing.Point(464, 296);
		...
		private void btn_NoSigleton_Click(object sender, System.EventArgs e)
		{
			...
			if(s1.Equals(s2))
			{
				strResult = "the same instance";
			}
			else
			{
				strResult = "the defferent instance";
			}
